    ...
    <div class="container hero_container h-100">
        <div class="row hero_row">
            <div class="col-md-6 offset-md-6">
                ...
                <p class="myp">Продажа фаст фуда через мобильные приложения - самая быстрорастущая инновация 2018
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p class="about_text">Добро пожаловать в «JOC».
                    <br>Мы-компания, миссией которой является экономия самого важного ресурса в жизни человека- времени.
                    ...
                    себя оптимальный сеттинг.
                    <br>Делайте заказ и забирайте его к установленному вами времени: наше
